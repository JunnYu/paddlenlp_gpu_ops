...
parser.add_argument("--slack_channel_name", default="paddlenlp-gpu-ops-ci-nightly")
    ...
    if len(message) != 0:
        ...
        action_button = {
            ...
            "accessory": {
                ...
                "url": f"https://github.com/PaddlePaddle/paddlenlp/actions/runs/{os.environ['GITHUB_RUN_ID']}",
            },
        }
